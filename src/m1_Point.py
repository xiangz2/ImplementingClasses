...
class Point(object):
    ...
    def move_to(self, x, y):
        ...
        self.distancetraveled = self.distancetraveled + math.sqrt(self.dx **
                                                                  2 + self.dy ** 2)
    ...
    def move_by(self, dx, dy):
        ...
        self.distancetraveled = self.distancetraveled + math.sqrt(dx ** 2
                                                                  + dy ** 2)
    ...
    def get_distance_from_start(self):
        p1 = Point(self.starting_x, self.starting_y)
        return Point.get_distance_from(self, p1)
    ...
    def halfway_to(self, p2):
        x1 = p2.x
        y1 = p2.y
        p = Point((self.x + x1) / 2, (self.y + y1) / 2)
        return p
